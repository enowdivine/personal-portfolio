...
export const PROJECTS: Project[] = [
  {
    slug: "uniassist-africa",
    title: "UniAssist Africa",
    tagline: "Pan-African university admissions platform with channel partner network.",
    role: "Lead engineer",
    year: "2026",
    stack: ["Next.js", "Express", "TypeScript", "PostgreSQL", "Prisma"],
    url: "https://uniassist.africa",
    category: "EdTech",
    results: [
      "Relaunching the original CampusCamer platform across 54 African countries",
      "B2B layer: channel partners + counsellors with commission tracking",
      "Quotations, applications, and admissions in one workflow",
    ],
    metric: "54",
    metricLabel: "African countries",
  },
  {
    slug: "easykingspay",
    title: "EasyKingsPay",
